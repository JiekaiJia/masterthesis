...
class Agent:
    def __init__(self, agent_id, sync_t):
...
class Scheduler(Agent):
    ...
    """
    def __init__(self, agent_id, sync_t):
        super().__init__(agent_id, sync_t)
        self.action = Action()
        self.pkg_count = 0
    ...
    def send(self, sending_time):
        ...
        for i, _p in enumerate(p):
            ...
            packets[-1].sending_time = sending_time
...
class Server(Agent):
    def __init__(self, agent_id, sync_t, serving_rate, queue_max_len):
        super().__init__(agent_id, sync_t)
